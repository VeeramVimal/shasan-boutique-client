  ...
  return (
    <>
      <div className="bg-stone-300 h-screen flex justify-center pt-5 ">
        <div class="w-2/6  rounded-lg  shadow-lg bg-white-300 text-center pt-8 lg:h-96 md:h-full  ">
          <div class="px-8 py-8 items-center ">
            ...
            <div className="lg:pt-12 md:pt-6">
              <Link href="/" className="btn-action">
                <button class="bg-cyan-500  text-white-300 lg:text-xl font-normal lg:px-4 lg:py-2 md:px-4 md:py-2 rounded xs:text-xs ">
                  Go Back Home
                </button>
              </Link>
            </div>
