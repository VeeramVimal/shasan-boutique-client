export const STRINGS = {
    ...
    LOG_IN_PARA: "Sign in to your account and explore a world of possibilities. Your journey begins here. "
  ...
  export const MAINTENANCE_MESSAGE = {
    UNDER_MAINTENANCE_TXT: "Page Under Maintenance",
    MAINTENANCE_TXT: "We're currently working to improve this page. Please check back later!"
  }

  export const ALTERNATE_MESSAGE = {
